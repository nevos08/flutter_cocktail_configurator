...
part of 'orders_state.model.dart';
...
class _$OrdersStateImpl implements _OrdersState {
  _$OrdersStateImpl({required final List<Order> orders}) : _orders = orders;
...
abstract class _OrdersState implements OrdersState {
  factory _OrdersState({required final List<Order> orders}) = _$OrdersStateImpl;
