...
/// @nodoc
mixin _$CartState {
  List<CartConfiguration> get items => throw _privateConstructorUsedError;
...
abstract class $CartStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<CartConfiguration> items, double? discount, String? discountCode});
}
...
class _$CartStateImpl implements _CartState {
  _$CartStateImpl(
      {final List<CartConfiguration> items = const [],
      this.discount,
      this.discountCode})
      : _items = items;
  ...
  final List<CartConfiguration> _items;
  @override
  @JsonKey()
  List<CartConfiguration> get items {
  ...
  @override
  String toString() {
    return 'CartState(items: $items, discount: $discount, discountCode: $discountCode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_items), discount, discountCode);
...
abstract class _CartState implements CartState {
  factory _CartState(
      {final List<CartConfiguration> items,
      final double? discount,
      final String? discountCode}) = _$CartStateImpl;
